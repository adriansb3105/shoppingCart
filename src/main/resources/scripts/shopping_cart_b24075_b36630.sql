...
create table Client(	client_id int not null constraint PK_Client Primary Key,
...
create table Employee(	employee_id int not null constraint PK_Employee Primary Key,
						email varchar(255) not null,
						first_name varchar(255) not null,
						last_name varchar(255) not null,
						password varchar(255) not null,
...
create table Bill(	bill_id int not null constraint PK_Bill Primary Key,
					bill_date date not null,
					total_value float not null,
					client_id int not null,
					constraint FK_Bill_Client Foreign Key(client_id) references Client(client_id));

create table Order_Detail(	order_detail_id int not null constraint PK_Order_Detail Primary Key,
...
create table Shopping_Cart(	shopping_cart_id int not null constraint PK_Shopping_Cart Primary Key,
							quantity int not null,
